...
<body>
    ...
    <tr><td> Opis: </td><td><textarea rows = "3" name="opis" ></textarea> </tr></tr>
    ...
    <tr><td> Rok: </td><td><input type="date" name="rok" value="<?php echo date("Y-m-d");?>"> </tr></tr>
    <tr><td> Beleške: </td><td><textarea rows = "3" name="beleske" > </textarea> </tr></tr>
